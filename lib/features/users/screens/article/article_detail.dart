...
class _ArticleDetailState extends State<ArticleDetail> {
  ...
  ''';
    ...
    Share.share(content, subject: article.title);
  }
  ...
  Future<void> _summarizeArticle(String lang) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Đã tóm tắt bài viết!")));
    } catch (e) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Có lỗi xảy ra khi tóm tắt: $e")));
    } finally {
